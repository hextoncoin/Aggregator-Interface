		...
		<Flex pt="30px" flexDir="column" justifyContent="space-around" h="100%">
			...
			<Box zIndex={1}>
				...
				<Text color={'gray.300'} textAlign="center" mt={6}>
					Hexton Defi Aggregator looks for the best route for your trade <br /> among a variety of Dex Aggregators, guaranteeing you{' '}
					<br /> the best execution prices in DeFi.
					<br /> <br /> Try it now or{' '}
					<Link href="https://docs.hexton.exchange" isExternal textDecoration={'underline'}>
						learn more
